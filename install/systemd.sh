...
sudo ln -snf $path/systemd/home-chen-smb.mount /etc/systemd/system/home-chen-smb.mount
sudo ln -snf $path/systemd/home-chen-smb.automount /etc/systemd/system/home-chen-smb.automount
